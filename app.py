    ...
    with col2:
        ...
        if not df_members.empty:
            ...
            if not df_active.empty:
                ...
                # 📌 ปรับปรุง: เพิ่มการบังคับสีตัวหนังสือให้เป็นสีดำ (color: #000000) ป้องกันปัญหาใน Dark Mode
            ...
            if m_select_options:
                ...
                if st.button(btn_text, type=btn_color):
                    ...
                    if send_action_to_script(payload):
                        ...
                        st.error("❌ เกิดข้อผิดพลาด ไม่สามารถส่งคำสั่งสลับสถานะไปที่ Google Sheet ได้ รบกวนเช็กคอลัมน์ status ในตาราง")
...
# ==========================================
# เมนูที่ 2 - 5 โค้ดส่วนอื่นคงเดิมเพื่อให้ระบบเสถียร
# ==========================================
