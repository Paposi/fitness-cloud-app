...
# ==========================================
# 2. หน้าจัดการคอร์สและแก้ไขข้อมูลคอร์ส
# ==========================================
elif choice == "🛠️ การจัดการคอร์ส":
    st.header("🛠️ การจัดการคอร์สและแก้ไขข้อมูลคอร์สผสม")
    df_courses = load_data_from_sheet("courses")
...
# ==========================================
    ...
    if df_attendance.empty or df_members.empty or df_classes.empty: st.info("ยังไม่มีข้อมูล")
    else:
